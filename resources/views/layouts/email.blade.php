<!DOCTYPE html>
<!--[if IE 8]> <html lang="{{ $html_lang }}" class="ie8"> <![endif]-->
<!--[if !IE]><!-->
<html lang="{{ $html_lang }}">
<!--<![endif]-->
<head>
    ...
    <meta content="{{ $html_author }}" name="author" />
                                        ...
                                        <tr>
                                            <td class="wrapper">
                                                ...
                                                <table class="six columns">
                                                    <tr>
                                                        <td>
                                                            <a href="{{ route('home') }}"><img src="{{url('/')}}/assets/images/logo-email.png" /></a>
                                                        </td>
                                                ...
                                                <table class="six columns">
                                                    <tr>
                                                        <td class="wrapper text-right valign-middle">
                                                            <a href="javascript:;">Sobre o Nós</a>
                                                            &nbsp;
                                                            <a href="javascript:;">Política de Privacidade</a>
                                                            &nbsp;
                                                            <a href="javascript:;">Termos de Uso</a>
                                                        </td>
                                                        <td class="expander"></td>
                                                    </tr>
                                                </table>
