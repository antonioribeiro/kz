...
@section('content')
    {!! Form::opener(['route' => 'password.reset', 'class' => 'smart-form client-form', 'id' => 'smart-form-register', 'no-return-ajax-url' => true]) !!}
        ...
        <div class="form-group m-b-20">
            {!! Form::password('password', ['id' => 'email', 'type' => 'password', 'class' => 'form-control input-lg', 'placeholder' => 'Senha']) !!}
        </div>

        <div class="form-group m-b-20">
            {!! Form::password('password_confirmation', ['id' => 'email', 'type' => 'password_confirmation', 'class' => 'form-control input-lg', 'placeholder' => 'Redigite a senha']) !!}
        </div>
        ...
        <div class="m-t-20">
            Lembrou a senha? Clique <a href="/auth/login">aqui</a> para entrar.
        </div>
