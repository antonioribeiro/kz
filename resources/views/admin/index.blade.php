                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu media-list pull-right animated fadeInDown">
                            ...
                            <li class="media">
                                <a href="javascript:;">
                                    <div class="media-left"><img src="{{url('/')}}/templates/seantheme.com/color-admin-v1.9/admin/html/assets/img/user-1.jpg" class="media-object" alt="" /></div>
                                    <div class="media-body">
                            ...
                            <li class="media">
                                <a href="javascript:;">
                                    <div class="media-left"><img src="{{url('/')}}/templates/seantheme.com/color-admin-v1.9/admin/html/assets/img/user-2.jpg" class="media-object" alt="" /></div>
                                    <div class="media-body">
                    ...
                    <li class="dropdown navbar-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{url('/')}}/templates/seantheme.com/color-admin-v1.9/admin/html/assets/img/user-13.jpg" alt="" />
                ...
                <ul class="nav">
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="../angularjs/index.html">ANGULAR JS<i class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
                        </ul>
                    </li>
                    <li class="has-sub">
                        <a href="javascript:;">
